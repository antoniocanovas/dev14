...
class SaleTarget(models.Model):
    ...
    sale_vs_target = fields.Monetary(string='Sales vs Target', related='sale_amount', store=False)
    sale_over_target = fields.Monetary('Sale over Target', related='sale_amount', store=False)
