...
class ProductTemplate(models.Model):
    ...
    plate = fields.Char('Placa', store=True, copy=False)
    ...
    def copy_dictionary_name(self):
        if self.dictionary_name.id:
            dic = self.dictionary_name
            self.write({'name': dic.name, 'categ_id':dic.categ_id.id, 'type':dic.type})
    ...
    # Eliminado 9/8/23 para utilizar módulo de oca base_name_search_improved
#    @api.model
